...
export default function GuessWordGame({ vocabulary, updateWordStatus, onBackToGames }) {
    ...
    useEffect(() => {
        ...
        if (!gameInitialized && vocabulary.length > 0) {
            ...
            <div className="space-y-4 mt-4">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Word Guessing Game - {gameScore}/{gameWords.length} correct
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                                    ...
                                    >
                                        ...
                                        {!isCorrect && (
                                            <p className="mt-2 text-sm text-red-600 dark:text-red-400">
                                                Correct answer: <strong>{currentGameWord.english_word}</strong>
                                            </p>
                                        )}
                                    </div>
                                )}
